...
1. Project Overview
This project focuses on **channel occupancy prediction** using Machine Learning and Deep Learning models with Explainable AI (XAI) techniques. The goal is to predict spectrum occupancy patterns and understand model decisions using SHAP and LIME.
